# Raspberry Pi 240-MP customizations — decision log
...
Device: Raspberry Pi (Debian 13 "trixie"), 240-MP v2026.09.07
...
- **The Raspberry Pi boots straight into a chosen Plex Live TV channel**, no menu
...
- User reported: after switching the Raspberry Pi's Wi-Fi network, Plex playback fails
...
User wants the Raspberry Pi to boot straight into a specific Live TV channel,
...
- Should confirm real-world behavior once the Raspberry Pi is back on its actual home
